...
/**
 * Servlet implementation class ListeMesCommandesLivreur
 */
public class ListeMesCommandesLivreur extends HttpServlet {
	...
	private static final String PAGE_LISTE = "/WEB-INF/listeMesCommandesLivreur.jsp";
	 ...
	 */
	public ListeMesCommandesLivreur() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			Livreur livreur = (Livreur) session.getAttribute(SESSION_LIVREUR);
			
			page = PAGE_LISTE;
			request.setAttribute("message", MESS_BON);

			List<Commande_PenseBete> listecommandes = new ArrayList<Commande_PenseBete>();
			if((listecommandes =(ArrayList<Commande_PenseBete>) commandeDao.trouverLivreur(livreur.getId()))!=null) {
